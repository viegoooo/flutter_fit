...
class DatePickerModel extends CommonPickerModel {
  ...
  DatePickerModel(
      ...
      LocaleType locale})
      : super(locale: locale) {
    this.maxTime = maxTime ?? DateTime.now();
    this.minTime = minTime ?? DateTime(1950, 1, 1);

    currentTime = currentTime ?? DateTime(2000,1,1);
    if (currentTime != null) {
  ...
  @override
  String formatDateTime() {
     return formatDate(currentTime, [ymdw], locale);
  }
