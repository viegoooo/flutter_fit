          ...
          child: Container(
            ...
            decoration: new BoxDecoration(
              gradient: new LinearGradient(
                  colors: [
                    FitColor.loginGradientStart,
                    FitColor.loginGradientEnd
                  ],
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: new BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: FitColor.loginGradientStart,
                      offset: Offset(1.0, 6.0),
                      blurRadius: 20.0,
                    ),
                    BoxShadow(
                      color: FitColor.loginGradientEnd,
                      offset: Offset(1.0, 6.0),
                      blurRadius: 20.0,
                    ),
                  ],
                ...
                child: MaterialButton(
                    ...
                    splashColor: FitColor.loginGradientEnd,
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.only(top: 10.0),
                child: GestureDetector(
                  onTap: () => showInSnackBar("WeiBo button pressed"),
                  child: Container(
                    padding: const EdgeInsets.all(15.0),
                    decoration: new BoxDecoration(
                      shape: BoxShape.circle,
